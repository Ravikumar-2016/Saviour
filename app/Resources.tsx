    ...
    return (
      ...
      >
        ...
        <View style={styles.cardContent}>
          {imageSource && <Image source={imageSource} style={styles.resourceImageModern} />}
              ...
              <>
                ...
                <ScrollView style={styles.modalScrollView} showsVerticalScrollIndicator={false}>
                  <View style={styles.resourcePreview}>
                    {selectedResource.imageUrl && selectedResource.imageUrl.startsWith("data:image") && (
